...
SCRIPT_DIR="$HOME/Metagenomics_shotgun_tutorial/Binning/scripts/"
...
metabat2 -t 16 -a "$HOME"/Metagenomics_shotgun_tutorial/Binning/depth.txt -i "$GENOME_FASTA" -o "$OUTPUT_DIR"/MetaBatBins --minContig 2000 --noAdd -v
...
bin-refine "$HOME"/Metagenomics_shotgun_tutorial/Binning/CommunityScaffolds_assembly.gfa binning.tsv "$OUTPUT_DIR"binspreader-Rcorr --tmp-dir "$OUTPUT_DIR"/tmp --bin-dist -t 16 -Rcorr | tee binspreader-Rcorr.log
