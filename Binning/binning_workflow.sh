...
SCRIPT_DIR="/gpfs/data/BIO-DSB/Session7/MG_workshop_2026/Binning/scripts/"
...
bin-refine CommunityScaffolds_assembly.gfa binning.tsv "$OUTPUT_DIR/binspreader-Rcorr" --tmp-dir "$HOME/tmp" --bin-dist -t 16 -Rcorr | tee binspreader-Rcorr.log
